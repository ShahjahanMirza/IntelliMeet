...
```bash
git remote add encore encore://video-meeting-platform-hct2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/video-meeting-platform-hct2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/video-meeting-platform-hct2/settings/integrations/github)
